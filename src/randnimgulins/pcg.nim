...
when isMainModule:
  ...
  suite "PCG":
    ...
    test "Pcg32OnceInsecure":
      ...
      testPcg(initPcg32OnceInsecure(tseed.uint32, tstream.uint32))
    ...
    test "Pcg32OneSeqOnceInsecure":
      ...
      testPcg(initPcg32OneSeqOnceInsecure(tseed.uint32))
    ...
    test "Pcg64":
      ...
      testPcg(initPcg64(u128(tseed), u128(tstream)))
    ...
    test "Pcg64OneSeq":
      ...
      testPcg(initPcg64OneSeq(u128(tseed)))
    ...
    test "Pcg64Fast":
      ...
      testPcg(initPcg64Fast(u128(tseed)))
    ...
    test "Pcg64OnceInsecure":
      ...
      testPcg(initPcg64OnceInsecure(tseed.uint64, tstream.uint64))
    ...
    test "Pcg64OneSeqOnceInsecure":
      ...
      testPcg(initPcg64OneSeqOnceInsecure(tseed.uint64))
    ...
    test "Pcg128OnceInsecure":
      ...
      testPcg(initPcg128OnceInsecure(u128(tseed), u128(tstream)))
    ...
    test "Pcg128OneSeqOnceInsecure":
      ...
      testPcg(initPcg128OneSeqOnceInsecure(u128(tseed)))
