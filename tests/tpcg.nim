...
suite "PCG":
  ...
  test "Pcg32OnceInsecure":
    ...
    testRng(initPcg32OnceInsecure(tseed[0].uint32, tseed[1].uint32))
  ...
  test "Pcg32OneSeqOnceInsecure":
    ...
    testRng(initPcg32OneSeqOnceInsecure(tseed[0].uint32))
  ...
  test "Pcg64":
    ...
    testRng(initPcg64(u128(tseed[0]), u128(tseed[1])))
  ...
  test "Pcg64OneSeq":
    ...
    testRng(initPcg64OneSeq(u128(tseed[0])))
  ...
  test "Pcg64Fast":
    ...
    testRng(initPcg64Fast(u128(tseed[0])))
  ...
  test "Pcg64OnceInsecure":
    ...
    testRng(initPcg64OnceInsecure(tseed[0].uint64, tseed[1].uint64))
  ...
  test "Pcg64OneSeqOnceInsecure":
    ...
    testRng(initPcg64OneSeqOnceInsecure(tseed[0].uint64))
  ...
  when defined(release):
    ...
    test "Pcg128OnceInsecure":
      ...
      testRng(initPcg128OnceInsecure(u128(tseed[0]), u128(tseed[1])))
    ...
    test "Pcg128OneSeqOnceInsecure":
      ...
      testRng(initPcg128OneSeqOnceInsecure(u128(tseed[0])))
